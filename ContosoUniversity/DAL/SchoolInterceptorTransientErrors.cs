...
namespace ContosoUniversity.DAL
{
    ...
    //If you wanted to check connection resiliency for other types of queries, you could also override the NonQueryExecuting 
    //and ScalarExecuting methods, as the logging interceptor does.
